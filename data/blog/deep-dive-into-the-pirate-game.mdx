...
I did not expect, after 5 years, I would get asked this exact problem in an interview for a developer job. Thank to my high school experience,
...
Amaro is the captain of a pirate vessel. His mateys, Bart, Charlotte, Daniel, and Eliza, are the other
...
Feel free to stop scrolling down and ponder your strategy for a bit.
...
Let the logic above sink for a bit. And we shall explore what each pirate thinks exactly in each scenario.
...
Had B given E 1 coin, because the pirates are bloodthirsty, E would not be satisfactory as she can get the same amount from C anyway.
...
**Amaro will propose giving 98 coins to herself, 0 to B, 1 to C, 0 to D and 1 to E.
...
Eventually, there will be enough number of new-joiners to protect a new captain. Afterwards,
...
the voluntary voting crew will double in size, hence the power of 2.**
...
captain would bribe even-numbered crews. Let's investigate whether this still holds for 200+ pirates.
